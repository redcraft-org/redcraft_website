"""
Django settings for redcraft_website project.
...
ALLOWED_HOSTS = ['testing.redcraft.org', 'staging.redcraft.org', 'redcraft.org']
...
ROOT_URLCONF = 'redcraft_website.urls'
...
WSGI_APPLICATION = 'redcraft_website.wsgi.application'
